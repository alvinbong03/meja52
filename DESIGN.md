...
- The private control deck is one contiguous raised material band: Denim Lift over Batik Indigo while waiting, and Hibiscus Lacquer over Hibiscus Ink during the active turn. Separate it with one restrained Batik Ivory hairline; never split Fold, Call and Raise into decorative colour cards.
