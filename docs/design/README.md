...
Shared design guidance for the Digital Poker Table project.

- [Anti-Slop Rules.md](Anti-Slop%20Rules.md) — binding rules for avoiding generic AI-generated interface patterns.
- [Poker App Design Approval.md](Poker%20App%20Design%20Approval.md) — the decisions the owner needs to approve before interface implementation.
...
Deferred but committed features are summarised for new contributors in [Future Release Handoff.md](../Poker%20Chips/Future%20Release%20Handoff.md).
